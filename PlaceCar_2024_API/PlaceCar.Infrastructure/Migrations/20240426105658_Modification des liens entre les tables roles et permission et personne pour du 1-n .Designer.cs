...
namespace PlaceCar.Infrastructure.Migrations
{
    ...
    [Migration("20240426105658_Modification des liens entre les tables roles et permission et personne pour du 1-n ")]
    partial class Modificationdesliensentrelestablesrolesetpermissionetpersonnepourdu1n
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlaceCar.Domain.Entities.PersonneRole", b =>
                {
                    ...
                    b.HasKey("PersonneId", "RoleId")
                        .HasName("PK_PersonneRole");

                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("PersonneId", "RoleId"));

                    b.HasIndex("RoleId");

                    b.ToTable("PersonneRole", (string)null);
                });
